            ...
            <div className="mt-[4.5rem] bg-[url('https://www.aalto.fi/sites/g/files/flghsv161/files/styles/s2560wc_1800w_400h_n/public/2020-01/unto_rautio_aalto_dsc5557_web.jpg?itok=vZ292N9N')] py-9">
                <MainWrapper>
                    <div className="bg-[#ffcd00] relative top-36">
                        <h1 className="p-10 text-[1.875rem] md:text-[4.6875rem] leading-[2.25rem] md:leading-[5.5rem] text-black font-bold">Explore Aalto University</h1>
                        <div className="border-t border-black flex flex-row md:flex-col justify-between w-full items-center text-center">
